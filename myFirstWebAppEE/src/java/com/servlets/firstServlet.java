...
public class firstServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<html><body style='background-color:brown'>");
        out.println("<h1 style='text-align:center'>Prueba Servlet</h1>");
        out.println("Usuario Introducido: " + request.getParameter("user"));
        out.println("<br><br>");
        out.println("Contraseña Introducida: " + request.getParameter("pass"));
        out.println("<br><br>");
